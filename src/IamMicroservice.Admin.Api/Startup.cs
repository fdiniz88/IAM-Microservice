...
using IamMicroservice.Admin.Api.Configuration.Authorization;
using IamMicroservice.Admin.Api.ExceptionHandling;
using IamMicroservice.Admin.Api.Helpers;
using IamMicroservice.Admin.Api.Mappers;
using IamMicroservice.Admin.Api.Resources;
using IamMicroservice.Admin.EntityFramework.Shared.DbContexts;
using IamMicroservice.Admin.EntityFramework.Shared.Entities.Identity;
using IamMicroservice.Shared.Dtos;
using IamMicroservice.Shared.Dtos.Identity;
using IamMicroservice.Shared.Helpers;

namespace IamMicroservice.Admin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDataProtection()
                .SetApplicationName("IamMicroservice")
