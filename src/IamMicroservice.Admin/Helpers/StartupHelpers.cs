...
using IamMicroservice.Admin.ExceptionHandling;
using IamMicroservice.Admin.Configuration;
using IamMicroservice.Admin.Configuration.ApplicationParts;
using IamMicroservice.Admin.Configuration.Constants;
using IamMicroservice.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using IamMicroservice.Admin.Helpers.Localization;
using System.Linq;
using IamMicroservice.Admin.EntityFramework.MySql.Extensions;
using IamMicroservice.Admin.EntityFramework.Shared.Configuration;
using IamMicroservice.Admin.EntityFramework.SqlServer.Extensions;
using IamMicroservice.Admin.EntityFramework.PostgreSQL.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using IamMicroservice.Shared.Authentication;
using IamMicroservice.Shared.Configuration.Identity;

namespace IamMicroservice.Admin.Helpers
{
