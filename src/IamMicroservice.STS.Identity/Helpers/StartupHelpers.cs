...
using SendGrid;
using IamMicroservice.Shared.Configuration.Email;
using IamMicroservice.Shared.Email;
using IamMicroservice.STS.Identity.Configuration;
using IamMicroservice.STS.Identity.Configuration.ApplicationParts;
using IamMicroservice.STS.Identity.Configuration.Constants;
using IamMicroservice.STS.Identity.Configuration.Interfaces;
using IamMicroservice.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace IamMicroservice.STS.Identity.Helpers
{
